...
def generate_pdf(user):
    ...
    y_position -= 40
    pdf.drawString(100, 760, f'Faculty: {user.faculty.name}')
    y_position -= 40
    pdf.drawString(100, 740, f'Department: {user.department.name}')
    y_position -= 40
    pdf.drawString(100, 720, f'Gender: {user.gender.name}')
    y_position -= 40
